...
def generate_log(count=10):
	...
	while count >= 1:
		query_log = "{ip}\t{time}\t\"GET /{url} HTTP/1.1\"\t{statuscode}\t\"{referer}\"".format(time=time_str,url=sample_url(),ip=sample_ip(),referer=sample_referer(),statuscode=sample_status_code())
		print (query_log)
